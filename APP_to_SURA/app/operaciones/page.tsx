...
export default function OperacionesDashboard() {
  ...
  const firstName =
    user?.userDetails?.split('@')[0] ?? 'Operador'
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <CardHeader>
            ...
            <CardDescription>
              Generar una nueva solicitud de documentos para un cliente.
              Configure los documentos requeridos y envíe el enlace seguro.
            </CardDescription>
          </CardHeader>
        ...
        >
          <CardHeader>
            ...
            <CardDescription>
              Consulte el estado de las solicitudes existentes,
              reenvíe correos o vea los documentos cargados.
            </CardDescription>
          </CardHeader>
